...
/*!****************************!*\
  !*** ./env-variables.json ***!
  \****************************/
/*! exports provided: auth0Domain, clientId, apiIdentifier, rodeoServiceUrl, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"auth0Domain\":\"dev-ktt11zj0.eu.auth0.com\",\"clientId\":\"VW4Lal0kFyquInIZ80XbmmjUAOiu5oaL\",\"apiIdentifier\":\"https://localhost:5001/graphql\",\"rodeoServiceUrl\":\"https://www.rodeo.bg:2041/graphql\"}");
...
/***/ "./node_modules/graphql.js/graphql.js":
/*!********************************************!*\
  !*** ./node_modules/graphql.js/graphql.js ***!
  \********************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function () {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    function __doRequest(
      ...
      var http = __webpack_require__(/*! http */ "http"), https = __webpack_require__(/*! https */ "https"), URL = __webpack_require__(/*! url */ "url"), uri = URL.parse(url)
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "a795035e3333a278c24b6f3b6710e87f.node");
...
var BrowserWindow = __webpack_require__(/*! electron */ "electron").BrowserWindow;
var url = __webpack_require__(/*! url */ "url");
...
var BrowserWindow = __webpack_require__(/*! electron */ "electron").BrowserWindow;
var authService = __webpack_require__(/*! ./services/auth-service */ "./rodeo-de/services/auth-service.js");
var createAppWindow = __webpack_require__(/*! ./app-process */ "./rodeo-de/app-process.js");
var win = null;
...
var createAuthWindow = __webpack_require__(/*! ./auth-process */ "./rodeo-de/auth-process.js").createAuthWindow;
var createAppWindow = __webpack_require__(/*! ./app-process */ "./rodeo-de/app-process.js");
var authService = __webpack_require__(/*! ./services/auth-service */ "./rodeo-de/services/auth-service.js");
var gallagherService = __webpack_require__(/*! ./services/gallagher-discovery-service */ "./rodeo-de/services/gallagher-discovery-service.js");
var gallagherApiService = __webpack_require__(/*! ./services/gallagher-api-service */ "./rodeo-de/services/gallagher-api-service.js");
var rodeoService = __webpack_require__(/*! ./services/rodeo-service */ "./rodeo-de/services/rodeo-service.js");
function showWindow() {
...
/***/ "./rodeo-de/services/auth-service.js":
/*!*******************************************!*\
  !*** ./rodeo-de/services/auth-service.js ***!
  \*******************************************/
/*! no static exports found */
...
var url = __webpack_require__(/*! url */ "url");
var envVariables = __webpack_require__(/*! ../../env-variables.json */ "./env-variables.json");
var keytar = __webpack_require__(/*! keytar */ "./node_modules/keytar/lib/keytar.js");
var os = __webpack_require__(/*! os */ "os");
var apiIdentifier = envVariables.apiIdentifier, auth0Domain = envVariables.auth0Domain, clientId = envVariables.clientId;
var redirectUri = "http://localhost/callback";
var keytarService = "electron-openid-oauth";
var keytarAccount = os.userInfo().username;
...
function refreshTokens() {
    return __awaiter(this, void 0, void 0, function () {
        var refreshToken, refreshOptions, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, keytar.getPassword(keytarService, keytarAccount)];
                case 1:
                ...
                case 2:
                    _a.trys.push([2, 4, , 6]);
                    return [4 /*yield*/, axios(refreshOptions)];
                case 3:
                    response = _a.sent();
                ...
                case 7: throw new Error("No available refresh token.");
...
function loadTokens(callbackURL) {
    return __awaiter(this, void 0, void 0, function () {
        var urlParts, query, exchangeOptions, options, response, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    urlParts = url.parse(callbackURL, true);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, keytar.setPassword(keytarService, keytarAccount, refreshToken)];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
function logout() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, keytar.deletePassword(keytarService, keytarAccount)];
                case 1:
                    _a.sent();
                    accessToken = null;
                    profile = null;
...
ipcMain.handle('logout', function (event) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
ipcMain.handle('profile', function (event) { return profile; });
ipcMain.handle('accessToken', function (event) { return accessToken; });
module.exports = {
...
/***/ "./rodeo-de/services/gallagher-api-service.js":
/*!****************************************************!*\
  !*** ./rodeo-de/services/gallagher-api-service.js ***!
  \****************************************************/
/*! no static exports found */
...
var gallagherService = __webpack_require__(/*! ./gallagher-discovery-service */ "./rodeo-de/services/gallagher-discovery-service.js");
var options = {
    attributeNamePrefix: "@_",
    attrNodeName: "attr",
    textNodeName: "#text",
...
module.exports = {
    init: function () {
        ipcMain.handle('loadSessions', function (_) { return __awaiter(void 0, void 0, void 0, function () {
            var url, res, jsonObj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = gallagherService.getIp();
                        return [4 /*yield*/, axios("http://" + url + ":15001/sessions")];
                    case 1:
                        res = _a.sent();
                        if (parser.validate(res.data) === true) {
                            jsonObj = parser.parse(res.data, options);
        ...
        ipcMain.handle('loadSessionById', function (_, sessionId) { return __awaiter(void 0, void 0, void 0, function () {
            var url, res, jsonObj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = gallagherService.getIp();
                        return [4 /*yield*/, axios("http://" + url + ":15001/sessions/" + sessionId)];
                    case 1:
                        res = _a.sent();
                        if (parser.validate(res.data) === true) {
                            jsonObj = parser.parse(res.data, options);
...
/***/ "./rodeo-de/services/gallagher-discovery-service.js":
/*!**********************************************************!*\
  !*** ./rodeo-de/services/gallagher-discovery-service.js ***!
  \**********************************************************/
/*! no static exports found */
...
var listen = function () {
    ...
    client.on('message', function (message, info) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            parsedIp = info.address.replace('::ffff:', '');
            return [2 /*return*/];
        });
    }); });
    ipcMain.handle('gallagherUrl', function () { return parsedIp; });
};
module.exports = {
    listen: listen,
    getIp: function (_) { return parsedIp; }
};


/***/ }),

/***/ "./rodeo-de/services/rodeo-service.js":
/*!********************************************!*\
  !*** ./rodeo-de/services/rodeo-service.js ***!
  \********************************************/
/*! no static exports found */
...
var ipcMain = __webpack_require__(/*! electron */ "electron").ipcMain;
var graphql = __webpack_require__(/*! graphql.js */ "./node_modules/graphql.js/graphql.js");
var authService = __webpack_require__(/*! ./auth-service */ "./rodeo-de/services/auth-service.js");
var rodeoServiceUrl = __webpack_require__(/*! ../../env-variables.json */ "./env-variables.json").rodeoServiceUrl;
var graph = null;
ipcMain.handle('animalsQuery', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, graph("\n        query {\n            animals {\n            items {\n                animalId\n                name\n            }\n          }\n        }\n    ")()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); });
module.exports = {
    initGraphQLClient: function () {
        graph = graphql(rodeoServiceUrl, {
            method: "POST",
            headers: {
                "Authorization": function () { return "Bearer " + authService.getAccessToken(); }
            }
        });
    }
};
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./rodeo-de/main.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./rodeo-de/main.js */"./rodeo-de/main.js");
