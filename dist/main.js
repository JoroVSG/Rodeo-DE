...
/*!****************************!*\
  !*** ./env-variables.json ***!
  \****************************/
/*! exports provided: auth0Domain, clientId, apiIdentifier, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"auth0Domain\":\"dev-ktt11zj0.eu.auth0.com\",\"clientId\":\"VW4Lal0kFyquInIZ80XbmmjUAOiu5oaL\",\"apiIdentifier\":\"https://localhost:5001/graphql\"}");
...
exports.humanize = __webpack_require__(/*! ms */ "./node_modules/axios/node_modules/ms/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "c56f6a9e02fa34b0e6a44f7ee06dc3aa.node");
...
/* harmony default export */ __webpack_exports__["default"] = (createAppWindow);

/***/ }),

/***/ "./rodeo-de/auth-process.ts":
/*!**********************************!*\
  !*** ./rodeo-de/auth-process.ts ***!
  \**********************************/
/*! exports provided: default, createAuthWindow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAuthWindow", function() { return createAuthWindow; });
/* harmony import */ var _app_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-process */ "./rodeo-de/app-process.ts");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/auth-service */ "./rodeo-de/services/auth-service.ts");
...
function createWindow() {
  ...
  win.loadURL(_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["default"].getAuthenticationURL());
  var webRequest = win.webContents.session.webRequest;
  var filter = {
    urls: ['http://localhost/callback*']
  };
  webRequest.onBeforeRequest(filter, /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              url = _ref.url;
              _context.next = 3;
              return _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["default"].loadTokens(url);

            case 3:
              Object(_app_process__WEBPACK_IMPORTED_MODULE_0__["default"])();
              return _context.abrupt("return", destroyAuthWin());
  ...
  win.on('authenticated', destroyAuthWin);
...
function createLogoutWindow() {
  var logoutWindow = new electron__WEBPACK_IMPORTED_MODULE_1__["BrowserWindow"]({
    show: false
  });
  logoutWindow.loadURL(_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["default"].getLogOutUrl());
  logoutWindow.on('ready-to-show', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            logoutWindow.close();
            _context2.next = 3;
            return _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["default"].logout();
...
var createAuthWindow = createWindow;
...
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _app_process__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app-process */ "./rodeo-de/app-process.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/auth-service */ "./rodeo-de/services/auth-service.ts");
/* harmony import */ var _auth_process__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth-process */ "./rodeo-de/auth-process.ts");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
function showWindow() {
  return _showWindow.apply(this, arguments);
}

function _showWindow() {
  _showWindow = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["default"].refreshTokens();

          case 3:
            return _context.abrupt("return", Object(_app_process__WEBPACK_IMPORTED_MODULE_1__["default"])());

          case 6:
            _context.prev = 6;
            _context.t0 = _context["catch"](0);
            Object(_auth_process__WEBPACK_IMPORTED_MODULE_3__["createAuthWindow"])();
...
electron__WEBPACK_IMPORTED_MODULE_0__["app"].on('ready', showWindow); // Quit when all windows are closed.

electron__WEBPACK_IMPORTED_MODULE_0__["app"].on('window-all-closed', electron__WEBPACK_IMPORTED_MODULE_0__["app"].quit);

/***/ }),

/***/ "./rodeo-de/services/auth-service.ts":
/*!*******************************************!*\
  !*** ./rodeo-de/services/auth-service.ts ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! url */ "url");
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(url__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _env_variables_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../env-variables.json */ "./env-variables.json");
var _env_variables_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../env-variables.json */ "./env-variables.json", 1);
/* harmony import */ var keytar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! keytar */ "./node_modules/keytar/lib/keytar.js");
/* harmony import */ var keytar__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(keytar__WEBPACK_IMPORTED_MODULE_4__);
...
var apiIdentifier = _env_variables_json__WEBPACK_IMPORTED_MODULE_3__.apiIdentifier,
    auth0Domain = _env_variables_json__WEBPACK_IMPORTED_MODULE_3__.auth0Domain,
    clientId = _env_variables_json__WEBPACK_IMPORTED_MODULE_3__.clientId;
var redirectUri = "http://localhost/callback";
var keytarService = "electron-openid-oauth";
var keytarAccount = os__WEBPACK_IMPORTED_MODULE_1__["userInfo"]().username;
...
function _refreshTokens() {
  _refreshTokens = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var refreshToken, refreshOptions, response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return keytar__WEBPACK_IMPORTED_MODULE_4__["getPassword"](keytarService, keytarAccount);
          ...
          case 2:
            ...
            refreshOptions = {
              method: "POST",
              url: "https://".concat(auth0Domain, "/oauth/token"),
              headers: {
                "content-type": "application/json"
              },
              data: {
            ...
            _context.prev = 5;
            _context.next = 8;
            return axios__WEBPACK_IMPORTED_MODULE_5___default()(refreshOptions);

          case 8:
            response = _context.sent;
            accessToken = response.data.access_token;
            profile = jwt_decode__WEBPACK_IMPORTED_MODULE_0___default()(response.data.id_token);
            _context.next = 18;
            break;
...
function loadTokens(_x) {
  return _loadTokens.apply(this, arguments);
}

function _loadTokens() {
  _loadTokens = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(callbackURL) {
    var urlParts, query, exchangeOptions, options, response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            urlParts = url__WEBPACK_IMPORTED_MODULE_2__["parse"](callbackURL, true);
          ...
          case 7:
            ...
            _context2.next = 14;
            return keytar__WEBPACK_IMPORTED_MODULE_4__["setPassword"](keytarService, keytarAccount, refreshToken);
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return keytar__WEBPACK_IMPORTED_MODULE_4__["deletePassword"](keytarService, keytarAccount);
...
function getLogOutUrl() {
  return "https://".concat(auth0Domain, "/v2/logout");
}
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./rodeo-de/main.ts ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./rodeo-de/main.ts */"./rodeo-de/main.ts");
